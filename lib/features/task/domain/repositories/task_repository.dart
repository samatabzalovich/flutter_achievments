...
abstract class TaskRepo {
  ...
  ResultFuture<void> completeTask(String id); // for child then parent sees it in pending which means he can accept or reject it
  ...
  ResultFuture<void> suggestTask(String id);
